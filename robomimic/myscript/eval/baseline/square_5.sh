...
# モデルファイルと共通パラメータ
DATASET_PATH="/work/robomimic/datasets/square/ph/low_dim_v15_6.hdf5"
N_ROLLOUTS=100
HORIZON=400
SEED=10
CSV_BASE="/work/robomimic/csv/result/baseline/square/ncp_u256"
mkdir -p $(dirname ${CSV_BASE})   
MODEL_DIR="/work/robomimic/trained_models/square/u256"
count=21
unit=256
