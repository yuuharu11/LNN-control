...
declare -A models=(
  ...
  ["ncp-pure_noised_u128_seed1"]="/work/robomimic/bc_trained_models/lift/ncp-pure-best/ph/unit128/noise_0.01/seed1/models/model_epoch_100_low_dim_v15_success_1.0.pth"
)
