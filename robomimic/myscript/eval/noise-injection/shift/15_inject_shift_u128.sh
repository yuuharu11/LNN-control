...
# モデルファイルと共通パラメータ
DATASET_PATH="/work/robomimic/datasets/lift/ph/low_dim_v15_18.hdf5"
N_ROLLOUTS=100
HORIZON=400
SEED=0
shift=(0.08 0.09 0.10)
CSV_BASE="/work/robomimic/csv/result/error/LNN/6-6-6/3bit/99.9_1/shift/u128"
LOG_PATH="/work/robomimic/logs/quantize/best/calibration/LNN/u128/99.9_1"
mkdir -p ${CSV_BASE}
