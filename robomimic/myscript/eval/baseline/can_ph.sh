...
HORIZON=400
SEED=0
CSV_PATH="/work/robomimic/csv/eval/can/profile.csv"
...
declare -A models=(
  ...
  #["ncp_u256_best_seed1"]="/work/robomimic/bc_trained_models/can/ncp-pure-best/ph/unit256/seed1/models/model_epoch_250_low_dim_v15_success_0.64.pth"
  #["ncp_u256_best_seed2"]="/work/robomimic/bc_trained_models/can/ncp-pure-best/ph/unit256/seed2/models/model_epoch_750_low_dim_v15_success_0.7.pth"
  #["ncp_u256_best_seed3"]="/work/robomimic/bc_trained_models/can/ncp-pure-best/ph/unit256/seed3/models/model_epoch_100_low_dim_v15_success_0.68.pth"
)
