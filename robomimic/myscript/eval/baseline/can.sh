...
# モデルファイルと共通パラメータ
DATASET_PATH="/work/robomimic/datasets/can/ph/low_dim_v15_2.hdf5"
N_ROLLOUTS=100
HORIZON=400
SEED=10
CSV_BASE="/work/robomimic/result/baseline/can/mlp"
mkdir -p $(dirname ${CSV_BASE})]]
MODEL_DIR="/work/robomimic/trained_models/can/mlp"
count=11
