...
# モデルファイルと共通パラメータ
DATASET_PATH="/work/robomimic/datasets/square/ph/low_dim_v15_5.hdf5"
N_ROLLOUTS=100
HORIZON=400
SEED=1
CSV_BASE="/work/robomimic/csv/result/baseline/square/ncp_u128"
mkdir -p $(dirname ${CSV_BASE})   
MODEL_DIR="/work/robomimic/trained_models/square/u128"
count=1
unit=128
