...
# モデルファイルと共通パラメータ
DATASET_PATH="/work/robomimic/datasets/lift/ph/low_dim_v15_12.hdf5"
N_ROLLOUTS=100
HORIZON=400
SEED=10
shift=(0.04 0.05 0.06 0.07)
CSV_BASE="/work/robomimic/csv/result/error/LNN_standardization/6-6-6/shift/u64"
