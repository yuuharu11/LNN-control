...
declare -A models=(
  # lift task models
  ["ncp_u256_nomix"]="/work/robomimic/bc_trained_models/lift/lnn/seed1_ph/models/model_epoch_2000.pth"
  ["ncp_u256"]="/work/robomimic/bc_trained_models/lift/lnn_lstm/units256/ph/models/model_epoch_1150_low_dim_v15_success_1.0.pth"
  ["ncp_u128"]="/work/robomimic/bc_trained_models/lift/lnn_lstm/units128/ph/models/model_epoch_50_low_dim_v15_success_1.0.pth"
  ["cfc_u256"]="/work/robomimic/bc_trained_models/lift/lnn_cfc/seed5_ph/models/model_epoch_2000.pth"
